...
#'
#' @export
as.data.frame.taxa_taxon_db <- function(x, row.names = NULL, optional = FALSE, ..., base_vectors = FALSE) {
  if (base_vectors) {
    x <- as.character(x)
  }
...
#' @inheritParams as.data.frame.taxa_taxon_db
#'
#' @importFrom tibble as_tibble
#' @export
as_tibble.taxa_taxon_db <- function(x, ..., base_vectors = FALSE) {
