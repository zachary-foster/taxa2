...
#' Count observation assigned in \code{\link{taxmap}}#'#' Count observations assigned to a specific taxon in an \code{\link{taxmap}}.#' This does not include observations assigned to subtaxa.#' \preformatted{#' obj$n_obs_1(target)#' n_obs_1(obj, target)}#'#' @param obj (\code{\link{taxmap}})#' @param target The name of the list/vector/table in \code{obj$data}#'#' @return \code{numeric}#'#' @examples#' n_obs_1(ex_taxmap, "info")#'#' @family taxon_funcs#'#' @name n_obs_1NULL#' @exportn_obs_1 <- function(obj, ...) {  UseMethod("n_obs_1")}#' @exportn_obs_1.default <- function(obj, ...) {  stop("Unsupported class: ", class(obj)[[1L]], call. = FALSE, domain = NA)}#' @exportn_obs_1.Taxmap <- function(obj, ...) {  obj <- obj$clone(deep = TRUE) # Makes this style of executing the function imitate traditional copy-on-change  obj$n_obs_1(...)}
