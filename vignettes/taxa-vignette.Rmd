...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  message = FALSE,
  eval = FALSE # temporary for testing 
)
```
...
There is a set of functions to manipulate these data in a taxonomic context using functions based on the **dplyr** functions.
